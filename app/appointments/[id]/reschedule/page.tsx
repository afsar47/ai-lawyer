...
export default function AppointmentReschedulePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(`Error: ${errorData.error || 'Failed to reschedule consultation'}`);
      }
    } catch (error) {
      console.error('Error rescheduling appointment:', error);
      alert('Error rescheduling consultation. Please try again.');
    } finally {
  ...
  if (loading) {
    return (
      <ProtectedRoute>
        <SidebarLayout title="Reschedule Consultation" description="Change consultation time">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-6">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mt-4">
              Reschedule Consultation: {appointment?.patientName}
            </h1>
          </div>
          
          <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-6">Reschedule Consultation</h3>
            
            <div className="space-y-6">
              {/* Current Consultation Info */}
              <div className="bg-gray-50 rounded-lg p-4 mb-6">
                <h4 className="text-sm font-medium text-gray-700 mb-3">Current Consultation</h4>
              ...
              {/* New Consultation Date and Time */}
              <div className="border-t pt-6">
                <h4 className="text-md font-medium text-gray-900 mb-4">New Consultation Details</h4>
              ...
              <div className="flex items-center justify-end space-x-3 pt-6 border-t">
                ...
                >
                  ...
                  <span>{isSubmitting ? 'Rescheduling...' : 'Reschedule Consultation'}</span>
                </button>
              </div>
            </div>
          </form>
